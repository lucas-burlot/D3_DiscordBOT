...
const prefix = "+";
const DISCORD_TOKEN = 'YOUR DISCORD TOKEN HERE';
const BATTLENET_TOKEN = 'YOUR BATTLENET TOKEN HERE';
            ...
            getJSON('https://eu.api.blizzard.com/d3/profile/' + args[0] + '%23' + args[1] + '/?locale=fr_FR&access_token= ' + BATTLENET_TOKEN , function(error, response){
                if(response != null){
                    ...
                    .addFields(
                        ...
                        + '\n Number of characters : ' + getCharacter() },
